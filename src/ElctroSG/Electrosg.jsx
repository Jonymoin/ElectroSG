...
const ElectricalSG = () => {
  ...
  const whatsappLink = `https://wa.me/6584130016?text=Hello,%20I%20need%20electrical%20service%20assistance.`;
              ...
              <div className="space-y-8">
                <div className="flex items-center space-x-4 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl">
                  ...
                  <div>
                    ...
                    <p className="text-blue-600 font-medium">+65 8413 0016</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4 p-6 bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl">
                  ...
                  <div>
                    ...
                    <p className="text-green-600 font-medium">+65 8413 0016</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4 p-6 bg-gradient-to-r from-red-50 to-pink-50 rounded-2xl">
                  ...
                  <div>
                    ...
                    <p className="text-red-600 font-medium">washertroubleshootsg@gmail.com</p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">+65 8413 0016</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">washertroubleshootsg@gmail.com</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
